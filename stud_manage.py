...
#Visit: CodeWithCurious.com/projects for more projects
        title = Label(self.root,text="Devlop By:Durai Python Developer",bd=3,relief=GROOVE,font=("Brush Script MT",18),bg='blue',fg='white' )
